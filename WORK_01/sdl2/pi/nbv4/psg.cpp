...
{
	IExternalChip* pExt = reinterpret_cast<IExternalChip*>(psg->userdata);
...
void psg_bind(PPSG psg)
{
	...
	if (pExt == NULL)
	{
		pExt = static_cast<IExternalChip*>(CNbv4Manager::GetInstance()->GetInterface(IExternalChip::kAY8910, 4000000));
