...
#define	mainmem		((UINT8 *)0x02000000)

void CPUCALL z80a_initialize(void);
void CPUCALL z80a_reset(void);
void CPUCALL __attribute__((long_call)) z80a_interrupt(REG8 irq);
void CPUCALL z80a_nonmaskedinterrupt(void);
void CPUCALL __attribute__((long_call)) z80a_execute(void);
void CPUCALL z80a_step(void);
