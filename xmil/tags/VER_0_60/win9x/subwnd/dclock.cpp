...
{
	::pal_makegrad(m_pal32, 4, xmiloscfg.clockcolor1, xmiloscfg.clockcolor2);
}
...
void DispClock::Reset()
{
	...
	if (xmiloscfg.clockfnt >= _countof(s_pattern))
	{
	...
	m_pPattern = &s_pattern[xmiloscfg.clockfnt];
	m_cCharaters = xmiloscfg.clockx;
