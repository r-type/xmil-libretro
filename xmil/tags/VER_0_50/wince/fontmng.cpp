...
static const TCHAR deffontface[] = TEXT("ÇlÇr ÉSÉVÉbÉN");
static const TCHAR deffontface2[] = TEXT("ÇlÇr ÇoÉSÉVÉbÉN");
...
static void getlength1(FNTMNG fhdl, FNTDAT fdat, const TCHAR *string,
																int leng) {

	SIZE	fntsize;

	if (GetTextExtentPoint32(fhdl->hdcimage, string, leng, &fntsize)) {
...
static void fontmng_getchar(FNTMNG fhdl, FNTDAT fdat, const TCHAR *string) {
	...
	leng = lstrlen(string);
	ExtTextOut(fhdl->hdcimage, 0, 0, ETO_OPAQUE, NULL, string, leng, NULL);
